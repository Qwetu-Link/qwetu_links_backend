...
<head>
    ...
    <style>
        * {
        ...
        /* Rental Brand Colors: Orange, White, Blue */
        :root {
            --rental-primary: #f97316;
            --rental-blue: #2563eb;
            --rental-white: #ffffff;
            --rental-bg-light: #fff7ed;
            --rental-border: #fed7aa;
            --brand-dark: #0f172a;
            --gray-bg: #f8fafc;
        }
        ...
        .btn-outline {
            border: 1.5px solid var(--rental-primary);
        ...
        .hero-content h1 {
            ...
            line-height: 1.2;
            margin-bottom: 20px;
            background: linear-gradient(to right, #0f172a, var(--rental-primary));
        ...
        .about-wrapper {
            ...
            padding: 40px;
            margin: 20px 0 40px;
            border-left: 6px solid var(--rental-primary);
        }
        ...
        .pricing-card:hover {
            ...
            border-color: var(--rental-primary);
            box-shadow: 0 24px 40px rgba(249, 115, 22, 0.12);
        }
        ...
        .pricing-description {
            ...
            margin-bottom: 24px;
            font-size: 0.85rem;
            border-bottom: 1px dashed var(--rental-border);
            padding-bottom: 16px;
        }
        ...
        /* Contact & Newsletter (original styles) */
        .contact-wrapper {
            display: flex;
            flex-wrap: wrap;
            gap: 40px;
...
<body>
    ...
    <footer class="footer container">
        ...
        <p>© 2026 Qwetu Link Rental Management — Smart Property & Tenant Management</p>
    </footer>
    ...
    <script>
        ...
        if (subForm) {
            subForm.addEventListener('submit', (e) => {
                ...
                if (email && email.includes('@')) {
                    alert(`✨ Thanks! ${email} will receive rental management updates.`);
                    subForm.reset();
                } else {
        ...
        if (contactForm) {
            contactForm.addEventListener('submit', (e) => {
                e.preventDefault();
                alert('✅ Message received! Our rental specialist will contact you within 24 hours.');
                contactForm.reset();
            });
        }

        // simple anchor smoothness for pricing link
